-- Fix security warnings - final corrected version
-- Only fix views and functions that actually exist with correct columns

-- ==============================================
-- FIX VIEWS: Remove SECURITY DEFINER
-- ==============================================

-- Drop backup_stats view entirely - the table structure doesn't support it
